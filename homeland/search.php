...
if(isset($_POST['btn_search'])) {
    ...
    $offers = $_POST['offers'];
    $cities = $_POST['cities'];
    $sql = "SELECT * FROM `props` WHERE home_type LIKE '%$types%' OR  
    ...
    // header("Location: http://localhost/homeland_clone/homeland");
                ...
                <?php foreach ($listings as $listing) :  ?>
                    <div class="col-md-6 col-lg-4 mb-4">
                        <div class="property-entry h-100">
                            <a href="<?php echo base_url; ?>/property-details.php?id=<?php echo $listing->id; ?>" class="property-thumbnail">
                                <div class="offer-type-wrap">
                                    <span class="offer-type bg-<?php if ($listing->type == "rent") echo "success";
                                                       else echo "danger"; ?>"><?php echo $listing->type ?></span>
                                </div>
