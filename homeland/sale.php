...
if (isset($_GET['type'])){
  ...
  $sql= "SELECT * FROM `props` WHERE type = '$type'";
  $stmt= $con ->prepare($sql);
  $stmt->execute();
  $sale_lists= $stmt->fetchAll(PDO::FETCH_OBJ);
      ...
      <div class="col-md-12">
        <div class="view-options bg-white py-3 px-3 d-md-flex align-items-center">
          <div class="mr-auto">
            ...
            <a href="<?php echo base_url; ?>/view-list.php" class="icon-view view-list"><span class="icon-view_list"></span></a>
...
<!--  card or list start -->
 <div class="site-section site-section-sm bg-light">
  <div class="container">
    ...
    <div class="row mb-5">
      <?php if (count($sale_lists) > 0) : ?>
        <?php foreach ($sale_lists as $sale_list) :  ?>
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="property-entry h-100 rounded">
              <a href="<?php echo base_url; ?>/property-details.php?id=<?php echo $sale_list->id; ?>" class="property-thumbnail">
                <div class="offer-type-wrap">
                  <span class="offer-type bg-<?php if ($sale_list->type == "rent") echo "success";
                                              else echo "danger"; ?>"><?php echo $sale_list->type ?></span>
                </div>
                <img src="images/<?php echo $sale_list->image ?>" alt="Image" class="img-fluid">
              </a>
              <div class="p-4 property-body">
                <a href="#" class="property-favorite"><span class="icon-heart-o"></span></a>
                <h2 class="property-title"><a href="property-details.php?id=<?php echo $sale_list->id; ?>"><?php echo $sale_list->name ?></a></h2>
                <span class="property-location d-block mb-3"><span class="property-icon icon-room"></span><?php echo $sale_list->location ?></span>
                <strong class="property-price text-primary mb-3 d-block text-success">$<?php echo $sale_list->price ?></strong>
                <ul class="property-specs-wrap mb-3 mb-lg-0">
                  <li>
                    <span class="property-specs">Beds</span>
                    <span class="property-specs-number"><?php echo $sale_list->beds ?></span>

                  </li>
                  <li>
                    <span class="property-specs">Baths</span>
                    <span class="property-specs-number"><?php echo $sale_list->baths ?></span>

                  </li>
                  <li>
                    <span class="property-specs">SQ FT</span>
                    <span class="property-specs-number"><?php echo $sale_list->sq_ft ?></span>
