...
if (isset($_GET['price'])){
  ...
  $sql_order_price= "SELECT * FROM `props` ORDER BY price $price";
  $stm= $con ->prepare($sql_order_price);
  $stm->execute();
  $price_lists= $stm->fetchAll(PDO::FETCH_OBJ);
...
<!--  card or list start -->
 <div class="site-section site-section-sm bg-light">
  <div class="container">
    ...
    <div class="row mb-5">
      <?php if (count($price_lists) > 0) : ?>
        <?php foreach ($price_lists as $price_list) :  ?>
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="property-entry h-100 rounded">
              <a href="<?php echo base_url; ?>/property-details.php?id=<?php echo $price_list->id; ?>" class="property-thumbnail">
                <div class="offer-type-wrap">
                  <span class="offer-type bg-<?php if ($price_list->type == "rent") echo "success";
                                              else echo "danger"; ?>"><?php echo $price_list->type ?></span>
                </div>
                <img src="images/<?php echo $price_list->image ?>" alt="Image" class="img-fluid">
              </a>
              <div class="p-4 property-body">
                <a href="#" class="property-favorite"><span class="icon-heart-o"></span></a>
                <h2 class="property-title"><a href="property-details.php?id=<?php echo $price_list->id; ?>"><?php echo $price_list->name ?></a></h2>
                <span class="property-location d-block mb-3"><span class="property-icon icon-room"></span><?php echo $price_list->location ?></span>
                <strong class="property-price text-primary mb-3 d-block text-success">$<?php echo $price_list->price ?></strong>
                <ul class="property-specs-wrap mb-3 mb-lg-0">
                  <li>
                    <span class="property-specs">Beds</span>
                    <span class="property-specs-number"><?php echo $price_list->beds ?></span>

                  </li>
                  <li>
                    <span class="property-specs">Baths</span>
                    <span class="property-specs-number"><?php echo $price_list->baths ?></span>

                  </li>
                  <li>
                    <span class="property-specs">SQ FT</span>
                    <span class="property-specs-number"><?php echo $price_list->sq_ft ?></span>
